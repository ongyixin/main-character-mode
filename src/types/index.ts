...
export interface ObjectCharacter {
  ...
  memories: string[];
  /** Neutral (default) portrait URL — kept for backward compatibility */
  portraitUrl?: string;
  /** Per-expression sprite URLs generated by NanoBanana */
...
export interface StoryCharacter {
  ...
  stance: string;
  memory?: string[];
  /** NanoBanana-generated portrait URL (neutral expression) */
  portrait?: string;
  /** Per-expression sprite URLs */
  portraits?: Partial<Record<CharacterExpression, string>>;
}
